...
The recommended way to upgrade is to re-run the one-liner installer. It is idempotent â€” running it on an existing install upgrades the binary and the watcher unit without touching your apps.
